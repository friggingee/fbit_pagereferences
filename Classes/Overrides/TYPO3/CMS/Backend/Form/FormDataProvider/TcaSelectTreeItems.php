<?php
namespace FBIT\PageReferences\Overrides\TYPO3\CMS\Backend\Form\FormDataProvider;
 ...
 */
class TcaSelectTreeItems extends \TYPO3\CMS\Backend\Form\FormDataProvider\TcaSelectTreeItems
{
    /**
    ...
    public function addData(array $result)
    {
        ...
        foreach ($result['processedTca']['columns'] as $fieldName => $fieldConfig) {
            ...
            if ($result['selectTreeCompileItems']) {
                ...
                $treeDataProvider = \FBIT\PageReferences\Overrides\TYPO3\CMS\Core\Tree\TableConfiguration\TreeDataProviderFactory::getDataProvider(
                    $fieldConfig['config'],
                    $table,
                    $fieldName,
                    $result['databaseRow']
            ...
            $result['selectTreeCompileItems'] = false;
        }
